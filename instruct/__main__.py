...
def main():
    ...
    ttl = timeit.timeit(
        ...
        setup='from __main__ import Test;t = Test(name_or_id="ben")',
        number=1000000,
    )
    per_round_ms = (ttl / 1000000) * 1000000
    print("Test with safeties: {:.2f} us".format(per_round_ms))
    ...
    ttl = timeit.timeit(
        "t.clear();t.name_or_id = 1",
        setup='from __main__ import TestOptimized as Test;t = Test(name_or_id="ben")',
        number=1000000,
    )
    per_round_ms = (ttl / 1000000) * 1000000
    print("Test without safeties: {:.2f} us".format(per_round_ms))
